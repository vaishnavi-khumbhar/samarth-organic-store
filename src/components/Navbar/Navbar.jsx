...
import { Menu, X, Search, ShoppingCart, Heart, User, ChevronDown, Droplet } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-14 md:h-18 lg:h-[72px] gap-4">
          {/* Logo + wordmark */}
          <NavLink to="/" className="flex items-center gap-2 md:gap-3 shrink-0 group">
            ...
            <span className="leading-tight">
              <span
                className="block font-serif text-lg md:text-2xl lg:text-2xl font-bold tracking-wide"
                style={{ color: "#7A2418" }}
              >
                SAMARTH
              </span>
              <span
                className="block text-[10px] md:text-xs lg:text-sm font-semibold tracking-[0.25em]"
                style={{ color: "#3C8C2E" }}
              >
                ORGANIC
              </span>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="relative">
              <input
                ...
                className="w-52 xl:w-64 pl-4 pr-9 py-2.5 rounded-full bg-[#FBF6EC] text-sm border border-transparent focus:border-[#F5B800] focus:bg-white focus:outline-none focus:ring-4 focus:ring-[#F5B800]/15 transition-all"
              />
              <Search size={16} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#a8967a]" />
            </div>
            ...
            <div className="flex items-center gap-2 pl-1">
              ...
              <button aria-label="Wishlist" className={iconBtn}>
                <Heart size={18} />
              </button>
              <button
                aria-label="Cart"
          ...
          <button
            ...
            className="lg:hidden relative w-11 h-11 flex items-center justify-center rounded-full bg-[#FBF6EC] text-[#7A2418] transition-colors"
          >
  ...
  >
    <X size={18} />
            ...
            <div className="flex-1 overflow-y-auto px-5 pt-3 pb-5">
              <div className="relative mb-5">
                <input
                  type="text"
                  placeholder="Search for products..."
                  className="w-full pl-4 pr-9 py-3 rounded-full bg-[#FBF6EC] text-sm border border-transparent focus:border-[#F5B800] focus:outline-none"
                />
                <Search size={16} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#a8967a]" />
              </div>
            ...
            <div className="flex items-center justify-around px-5 py-4 border-t border-[#F0E4CE] shrink-0">
              <button className="flex flex-col items-center gap-1.5 text-xs font-medium text-[#2B2B28]">
              ...
              <button className="flex flex-col items-center gap-1.5 text-xs font-medium text-[#2B2B28] relative">
                <span
